...
@section('title', 'Daftar - Beras Kartini')
                ...
                <div class="form-group">
                    ...
                    <div class="password-strength">
                        ...
                        <div class="strength-info">
                            ...
                            <span class="strength-tips">Minimal 8 karakter, gunakan huruf besar, kecil, dan angka</span>
                        </div>
                    </div>
                </div>
...
document.getElementById("signupForm").addEventListener("submit", function(e) {
    ...
    if (passwordStrength < 50) {
        showAlert('Password terlalu lemah. Gunakan kombinasi huruf besar, kecil, dan angka.', 'error');
        return;
    }
    ...
    .catch((error) => {
        ...
        switch(error.code) {
            ...
            case 'auth/operation-not-allowed':
                errorMessage = 'Registrasi tidak diizinkan saat ini.';
                break;
        }
